...
def preload_models(
    ...
    text_model_path='/project/data/models/suno/text_2.pt',#None,
    coarse_use_gpu=True,
    coarse_use_small=False,
    coarse_model_path='/project/data/models/suno/coarse_2.pt',#None,
    fine_use_gpu=True,
    fine_use_small=False,
    fine_model_path='/project/data/models/suno/fine_2.pt',#None,
    codec_use_gpu=True,
    force_reload=False,
    path=None,
):
